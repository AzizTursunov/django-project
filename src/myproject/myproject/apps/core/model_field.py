...
class MultilingialField(models.Field):
    ...
    def get_localized_field(self, lang_code, lang_name):
        ...
        localized_field = self.localized_field_model(
            ...
            unique=self.unique,
            blank=_blank,
            null=False,  # Ingore the null argument!
    ...
    def contribute_to_class(self, cls, name,
        ...
        def translated_value(self):
            ...
            val = self.__dict__.get(
                MultilingialField.localized_field_name(
                    name, language
                )
            )
            if not val:
...
class MultilingualCharField(models.CharField, MultilingialField):
    pass


class MultilingualTextField(models.TextField, MultilingialField):
    pass
...
class TranslatedField(object):
    ...
    def __get__(self, instance, owner):
        ...
        if lang_code == settings.LANGUAGE_CODE:
            # The fielfs of the default language are in the main model
